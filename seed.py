...
ABILITIES: list[dict] = [
  ...
  {"name":"Chaos Burst","mana_cost":6,"energy_type":"upright","ability_category":"combat","tags":"chaos,aoe,unpredictable","description":"Releases an unstable energy burst that damages targets randomly within a small area.","card_name":"The Fool"},
  {"name":"Arcane Convergence","mana_cost":8,"energy_type":"upright","ability_category":"combat","tags":"energy,control,burst","description":"Channels concentrated magical energy into a precise destructive beam.","card_name":"The Magician"},
  {"name":"Mind Pierce","mana_cost":5,"energy_type":"upright","ability_category":"combat","tags":"psychic,precision,mental","description":"Strikes the target’s mind directly, bypassing physical defenses.","card_name":"The High Priestess"},
  {"name":"Nature’s Wrath","mana_cost":9,"energy_type":"upright","ability_category":"combat","tags":"nature,aoe,growth","description":"Summons violent plant growth that entangles and damages enemies in an area.","card_name":"The Empress"},
  {"name":"Imperial Crush","mana_cost":10,"energy_type":"upright","ability_category":"combat","tags":"force,control,aoe","description":"Applies overwhelming pressure that crushes enemies within a controlled zone.","card_name":"The Emperor"},
  {"name":"Divine Judgment","mana_cost":9,"energy_type":"upright","ability_category":"combat","tags":"holy,aoe,ritual","description":"Calls down sacred energy that strikes all hostile targets in range.","card_name":"The Hierophant"},
  {"name":"Soul Sever","mana_cost":7,"energy_type":"upright","ability_category":"combat","tags":"bond,precision,spirit","description":"Targets emotional or spiritual links to inflict amplified damage.","card_name":"The Lovers"},
  {"name":"Charge Impact","mana_cost":8,"energy_type":"upright","ability_category":"combat","tags":"movement,force,burst","description":"Launches forward with immense force, damaging everything in the path.","card_name":"The Chariot"},
  {"name":"Inner Break","mana_cost":6,"energy_type":"upright","ability_category":"combat","tags":"body,precision,damage","description":"Strikes internal weaknesses to deal amplified damage to a single target.","card_name":"Strength"},
  {"name":"Silent Strike","mana_cost":5,"energy_type":"upright","ability_category":"combat","tags":"stealth,precision,shadow","description":"Delivers a concealed attack that deals increased damage if unseen.","card_name":"The Hermit"},
  {"name":"Fate Collapse","mana_cost":9,"energy_type":"upright","ability_category":"combat","tags":"luck,aoe,chaos","description":"Disrupts probability, causing unpredictable damage across enemies.","card_name":"The Wheel of Fortune"},
  {"name":"Verdict Slash","mana_cost":7,"energy_type":"upright","ability_category":"combat","tags":"truth,precision,cut","description":"Cuts through defenses by striking with perfect balance and accuracy.","card_name":"Justice"},
  {"name":"Stasis Break","mana_cost":8,"energy_type":"upright","ability_category":"combat","tags":"time,control,burst","description":"Freezes a target momentarily before shattering them with stored force.","card_name":"The Hanged Man"},
  {"name":"Entropy Wave","mana_cost":10,"energy_type":"upright","ability_category":"combat","tags":"decay,aoe,destruction","description":"Unleashes a wave of decay that erodes enemies over an area.","card_name":"Death"},
  {"name":"Equilibrium Surge","mana_cost":7,"energy_type":"upright","ability_category":"combat","tags":"balance,energy,burst","description":"Releases balanced energy that destabilizes enemies evenly.","card_name":"Temperance"},
  {"name":"Chain Dominion","mana_cost":9,"energy_type":"upright","ability_category":"combat","tags":"control,bind,aoe","description":"Summons binding chains that restrain and damage multiple enemies.","card_name":"The Devil"},
  {"name":"Cataclysm Shock","mana_cost":11,"energy_type":"upright","ability_category":"combat","tags":"explosion,aoe,destruction","description":"Triggers a massive explosion that devastates everything in range.","card_name":"The Tower"},
  {"name":"Radiant Restoration Blast","mana_cost":8,"energy_type":"upright","ability_category":"combat","tags":"light,damage,restore","description":"Fires a beam of radiant energy that damages enemies and heals allies slightly.","card_name":"The Star"},
  {"name":"Nightmare Surge","mana_cost":9,"energy_type":"upright","ability_category":"combat","tags":"illusion,aoe,fear","description":"Overwhelms enemies with illusions that deal damage through fear.","card_name":"The Moon"},
  {"name":"Solar Flare","mana_cost":10,"energy_type":"upright","ability_category":"combat","tags":"light,aoe,energy","description":"Emits an intense burst of solar energy damaging all nearby enemies.","card_name":"The Sun"},
  {"name":"Final Reckoning","mana_cost":10,"energy_type":"upright","ability_category":"combat","tags":"soul,aoe,judgment","description":"Calls forth a wave that damages enemies based on accumulated actions.","card_name":"Judgment"},
  {"name":"Reality Collapse","mana_cost":12,"energy_type":"upright","ability_category":"combat","tags":"space,aoe,destruction","description":"Distorts space itself, crushing everything within a defined area.","card_name":"The World"},
